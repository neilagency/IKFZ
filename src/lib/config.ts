export const siteConfig = {
  ...
  nav: [
    ...
    },
    {
      ...
      children: [
        { label: 'Berlin', href: '/kfz-zulassung-in-deiner-stadt/berlin/' },
        { label: 'Hamburg', href: '/kfz-zulassung-in-deiner-stadt/hamburg/' },
        { label: 'Köln', href: '/kfz-zulassung-in-deiner-stadt/koeln/' },
        { label: 'Essen', href: '/kfz-zulassung-in-deiner-stadt/essen/' },
